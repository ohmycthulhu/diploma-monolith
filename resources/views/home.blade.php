...
<!-- ========== HEADER ========== -->
<header id="header"
        class="u-header u-header--white-nav-links-xl u-header--bg-violet-xl u-header--static-xl u-header--show-hide-xl"
        ...
        <div id="logoAndNav" class="container-fluid py-xl-3">
            ...
            <nav class="js-mega-menu navbar navbar-expand-xl u-header__navbar u-header__navbar--no-space">
                ...
                <a class="navbar-brand u-header__navbar-brand-default u-header__navbar-brand-center u-header__navbar-brand-text-white"
                   href="index.html" aria-label="MyFlights">
                        ...
                        <li class="nav-item hs-has-sub-menu u-header__nav-item" data-event="hover"
                            ...
                            <ul id="flightsSubMenu"
                                ...
                                <li><a class="nav-link u-header__sub-menu-nav-link"
                                       href="https://transvelo.github.io/mytravel-html/html/flights/flights-list.html">Sidebar</a>
                                </li>
                                <li><a class="nav-link u-header__sub-menu-nav-link"
                                ...
                                <div class="row">
                                    <div class="col-12 col-xl-4">
                                        <ul class="u-header__sub-menu-nav-group u-header__sub-menu-bordered mb-3">
                                            <li><a class="nav-link u-header__sub-menu-nav-link"
                                                   href="https://transvelo.github.io/mytravel-html/html/others/destination.html">Destination</a>
                                            </li>
                                            <li><a class="nav-link u-header__sub-menu-nav-link"
                                                   href="https://transvelo.github.io/mytravel-html/html/others/about.html">About
                                                    us</a></li>
                                            <li><a class="nav-link u-header__sub-menu-nav-link"
                                                   href="https://transvelo.github.io/mytravel-html/html/others/contact.html">Contact</a>
                                            </li>
                                            <li><a class="nav-link u-header__sub-menu-nav-link"
                                                   href="https://transvelo.github.io/mytravel-html/html/others/terms-conditions.html">Terms
                                                    of Use</a></li>
                                            <li><a class="nav-link u-header__sub-menu-nav-link"
                                                   href="https://transvelo.github.io/mytravel-html/html/others/faq.html">FAQs</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-12 col-xl-4">
                                        <ul class="u-header__sub-menu-nav-group u-header__sub-menu-bordered mb-3">
                                            <li><a class="nav-link u-header__sub-menu-nav-link"
                                                   href="https://transvelo.github.io/mytravel-html/html/blog/blog-list.html">Blog</a>
                                            </li>
                                            <li><a class="nav-link u-header__sub-menu-nav-link"
                                                   href="https://transvelo.github.io/mytravel-html/html/blog/blog-single.html">Blog
                                                    Single</a></li>
                                            <li><a class="nav-link u-header__sub-menu-nav-link"
                                                   href="https://transvelo.github.io/mytravel-html/html/others/become-expert.html">Become
                                                    Expert</a></li>
                                            <li><a class="nav-link u-header__sub-menu-nav-link"
                                                   href="https://transvelo.github.io/mytravel-html/html/others/404.html">404</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="col-12 col-xl-4">
                                        <a href="https://transvelo.github.io/mytravel-html/documentation/index.html"
                                           class="btn btn-soft-primary mb-3 w-100"><span
                                                    class="fas fa-laptop-code mr-2"></span>Documentation</a>
                                        <a href="https://transvelo.github.io/mytravel-html/starter/index.html"
                                           class="btn btn-soft-secondary w-100"><span class="fas fa-th mr-2"></span>Starter</a>
                                    </div>
                                </div>
                            </div>
                            <!-- End Pages - Mega Menu -->
                ...
                <div class="position-relative u-header__search-lg pl-xl-4 ml-xl-1">
                    <a id="searchClassicInvoker" class="btn-text-secondary" href="javascript:;" role="button"
                    ...
                    <div id="searchClassic"
                         ...
                         aria-labelledby="searchClassicInvoker" style="animation-duration: 300ms;">
                ...
                <div class="pl-md-4 ml-xl-1 ml-auto shopping-cart">
                    ...
                    <div id="shoppingCartDropdown"
                         class="dropdown-menu dropdown-unfold dropdown-menu-right dropdown-menu-right-fix-xl-15 dropdown-menu-right-fix-wd-10 text-center p-7"
        ...
        <div class="container space-1">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-lg-6 col-xl-2dot4 mb-3 mb-md-4 pb-1">
                    <a class="d-block" href="https://transvelo.github.io/mytravel-html/html/others/destination.html">
                        <div class="min-height-240 rounded-border px-4 py-5 bg-img-hero transition-3d-hover gradient-overlay-half-bg-gradient-v2 gradient-overlay shadow-hover-2 dropdown"
                             style="background-image: url(/assets/img/235x240/img3.jpg);">
                ...
                <div class="col-md-4 col-lg-6 col-xl-2dot4 mb-3 mb-md-4 pb-1">
                    <a class="d-block" href="https://transvelo.github.io/mytravel-html/html/others/destination.html">
                        <div class="min-height-240 rounded-border px-4 py-5 bg-img-hero transition-3d-hover gradient-overlay-half-bg-gradient-v2 gradient-overlay shadow-hover-2 dropdown"
                             style="background-image: url(/assets/img/235x240/img7.jpg);">
                            <header class="w-100 d-flex justify-content-between">
                                <div class="position-relative">
                                    <h5 class="text-white font-weight-bold font-size-17 mb-1 text-lh-2 d-block">United
                                        States</h5>
                                </div>
                            </header>
                        </div>
                ...
                <div class="col-md-4 col-lg-6 col-xl-2dot4 mb-3 mb-md-4 pb-1">
                    <a class="d-block" href="https://transvelo.github.io/mytravel-html/html/others/destination.html">
                        <div class="min-height-240 rounded-border px-4 py-5 bg-img-hero transition-3d-hover gradient-overlay-half-bg-gradient-v2 gradient-overlay shadow-hover-2 dropdown"
                             style="background-image: url(/assets/img/235x240/img6.jpg);">
                            <header class="w-100 d-flex justify-content-between">
                                <div class="position-relative">
                                    <h5 class="text-white font-weight-bold font-size-17 mb-1 text-lh-2 d-block">
                                        Ukraine</h5>
                ...
                <div class="col-md-4 col-lg-6 col-xl-2dot4 mb-3 mb-md-4 pb-1">
                    <a class="d-block" href="https://transvelo.github.io/mytravel-html/html/others/destination.html">
                        <div class="min-height-240 rounded-border px-4 py-5 bg-img-hero transition-3d-hover gradient-overlay-half-bg-gradient-v2 gradient-overlay shadow-hover-2 dropdown"
                             style="background-image: url(/assets/img/235x240/img10.jpg);">
                            <header class="w-100 d-flex justify-content-between">
                                <div class="position-relative">
                                    <h5 class="text-white font-weight-bold font-size-17 mb-1 text-lh-2 d-block">
                                        France</h5>
                ...
                <div class="col-md-4 col-lg-6 col-xl-2dot4 mb-3 mb-md-4 pb-1">
                    <a class="d-block" href="https://transvelo.github.io/mytravel-html/html/others/destination.html">
                        <div class="min-height-240 rounded-border px-4 py-5 bg-img-hero transition-3d-hover gradient-overlay-half-bg-gradient-v2 gradient-overlay shadow-hover-2 dropdown"
                             style="background-image: url(/assets/img/235x240/img2.jpg);">
                            <header class="w-100 d-flex justify-content-between">
                                <div class="position-relative">
                                    <h5 class="text-white font-weight-bold font-size-17 mb-1 text-lh-2 d-block">
                                        India</h5>
                ...
                <div class="col-md-4 col-lg-6 col-xl-2dot4 mb-3 mb-md-4 pb-1">
                    <a class="d-block" href="https://transvelo.github.io/mytravel-html/html/others/destination.html">
                        <div class="min-height-240 rounded-border px-4 py-5 bg-img-hero transition-3d-hover gradient-overlay-half-bg-gradient-v2 gradient-overlay shadow-hover-2 dropdown"
                             style="background-image: url(/assets/img/235x240/img5.jpg);">
                            <header class="w-100 d-flex justify-content-between">
                                <div class="position-relative">
                                    <h5 class="text-white font-weight-bold font-size-17 mb-1 text-lh-2 d-block">United
                                        Kingdom</h5>
                ...
                <div class="col-md-4 col-lg-6 col-xl-2dot4 mb-3 mb-md-4 pb-1">
                    <a class="d-block" href="https://transvelo.github.io/mytravel-html/html/others/destination.html">
                        <div class="min-height-240 rounded-border px-4 py-5 bg-img-hero transition-3d-hover gradient-overlay-half-bg-gradient-v2 gradient-overlay shadow-hover-2 dropdown"
                             style="background-image: url(/assets/img/235x240/img9.jpg);">
                            <header class="w-100 d-flex justify-content-between">
                                <div class="position-relative">
                                    <h5 class="text-white font-weight-bold font-size-17 mb-1 text-lh-2 d-block">
                                        Germany</h5>
                ...
                <div class="col-md-4 col-lg-6 col-xl-2dot4 mb-3 mb-md-4 pb-1">
                    <a class="d-block" href="https://transvelo.github.io/mytravel-html/html/others/destination.html">
                        <div class="min-height-240 rounded-border px-4 py-5 bg-img-hero transition-3d-hover gradient-overlay-half-bg-gradient-v2 gradient-overlay shadow-hover-2 dropdown"
                             style="background-image: url(/assets/img/235x240/img8.jpg);">
                            <header class="w-100 d-flex justify-content-between">
                                <div class="position-relative">
                                    <h5 class="text-white font-weight-bold font-size-17 mb-1 text-lh-2 d-block">
                                        Greece</h5>
                ...
                <div class="col-md-4 col-lg-6 col-xl-2dot4 mb-3 mb-md-4 pb-1">
                    <a class="d-block" href="https://transvelo.github.io/mytravel-html/html/others/destination.html">
                        <div class="min-height-240 rounded-border px-4 py-5 bg-img-hero transition-3d-hover gradient-overlay-half-bg-gradient-v2 gradient-overlay shadow-hover-2 dropdown"
                             style="background-image: url(/assets/img/235x240/img1.jpg);">
                            <header class="w-100 d-flex justify-content-between">
                                <div class="position-relative">
                                    <h5 class="text-white font-weight-bold font-size-17 mb-1 text-lh-2 d-block">
                                        Canada</h5>
                ...
                <div class="col-md-4 col-lg-6 col-xl-2dot4 mb-3 mb-md-4 pb-1">
                    <a class="d-block" href="https://transvelo.github.io/mytravel-html/html/others/destination.html">
                        <div class="min-height-240 rounded-border px-4 py-5 bg-img-hero transition-3d-hover gradient-overlay-half-bg-gradient-v2 gradient-overlay shadow-hover-2 dropdown"
                             style="background-image: url(/assets/img/235x240/img4.jpg);">
                            <header class="w-100 d-flex justify-content-between">
                                <div class="position-relative">
                                    <h5 class="text-white font-weight-bold font-size-17 mb-1 text-lh-2 d-block">
                                        Italy</h5>
        ...
        <div class="container">
            <div class="row justify-content-xl-between">
                ...
                <div class="col-12 col-md-6 col-lg-4 col-xl-1dot8 mb-6 mb-md-10 mb-xl-0">
                    ...
                    <ul class="list-group list-group-flush list-group-borderless mb-0">
                        <li><a class="text-decoration-on-hover list-group-item list-group-item-action"
                               href="https://transvelo.github.io/mytravel-html/html/others/about.html">About us</a></li>
                        <li><a class="text-decoration-on-hover list-group-item list-group-item-action"
                               href="https://transvelo.github.io/mytravel-html/html/others/contact.html">Careers</a>
                        </li>
                        <li><a class="list-group-item list-group-item-action text-decoration-on-hover"
                               href="https://transvelo.github.io/mytravel-html/html/others/terms-conditions.html">Terms
                                of Use</a></li>
                        <li><a class="list-group-item list-group-item-action text-decoration-on-hover"
                               href="https://transvelo.github.io/mytravel-html/html/others/terms-conditions.html">Privacy
                                Statement</a></li>
                        <li><a class="list-group-item list-group-item-action text-decoration-on-hover"
                               href="https://transvelo.github.io/mytravel-html/html/others/terms-conditions.html">Give
                                Us Feedbacks</a></li>
                    </ul>
                    <!-- End List Group -->
                </div>
                <div class="col-12 col-md-6 col-lg-4 col-xl-1dot8 mb-6 mb-md-10 mb-xl-0">
                    ...
                    <ul class="list-group list-group-flush list-group-borderless mb-0">
                        <li><a class="list-group-item list-group-item-action text-decoration-on-hover"
                               href="https://transvelo.github.io/mytravel-html/html/others/about.html">Investor
                                Relations</a></li>
                        <li><a class="list-group-item list-group-item-action text-decoration-on-hover"
                               href="https://transvelo.github.io/mytravel-html/html/others/about.html">Rewards
                                Program</a></li>
                        <li><a class="list-group-item list-group-item-action text-decoration-on-hover"
                               href="https://transvelo.github.io/mytravel-html/html/others/about.html">PointsPLUS</a>
                        </li>
                        <li><a class="list-group-item list-group-item-action text-decoration-on-hover"
                               href="https://transvelo.github.io/mytravel-html/html/others/about.html">Partners</a></li>
                        <li><a class="list-group-item list-group-item-action text-decoration-on-hover"
                               href="https://transvelo.github.io/mytravel-html/html/others/about.html">List My Hotel</a>
                        </li>
                    </ul>
                    <!-- End List Group -->
                </div>
                    ...
                    <ul class="list-group list-group-flush list-group-borderless mb-0">
                        <li>
                            <a class="list-group-item list-group-item-action text-decoration-on-hover"
                               href="https://transvelo.github.io/mytravel-html/html/others/terms-conditions.html">Account</a>
                        </li>
                        <li>
                            <a class="list-group-item list-group-item-action text-decoration-on-hover"
                               href="https://transvelo.github.io/mytravel-html/html/others/terms-conditions.html">Legal</a>
                        </li>
                        <li>
                            <a class="list-group-item list-group-item-action text-decoration-on-hover"
                               href="https://transvelo.github.io/mytravel-html/html/others/contact.html">Contact</a>
                        ...
                        <li>
                            <a class="list-group-item list-group-item-action text-decoration-on-hover"
                               href="https://transvelo.github.io/mytravel-html/html/others/terms-conditions.html">Affiliate
                                Program</a>
                        </li>
                        <li>
                            <a class="list-group-item list-group-item-action text-decoration-on-hover"
